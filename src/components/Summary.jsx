        ...
        <div className="breakfast-ticket">
          ...
          <div className="ticket-header">
            <div className="">
              <p>
                Ciente :
                <input type="text" name="name" onChange={handleInputChange} value={values.name} placeholder="Nombre de cliente" className="validaty input-client" />
              </p>
            </div>
            <div className="">
              <p>
              ...
              <p>
                Número de Mesa :
                <input type="text" name="table" onChange={handleInputChange} value={values.table} placeholder="N° mesa" className="validaty input-table" />
              </p>
            </div>
          </div>
